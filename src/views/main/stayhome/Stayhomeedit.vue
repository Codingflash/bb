<template>
    <div>
        ...
        <el-form :model="stayhomeform" ref="stayhomeform">
            ...
            <el-form-item>
                <rich-text @rich-change="setSnotice" formfield="sdetail"
                           :value="stayhomeform.sdetail"></rich-text>
            </el-form-item>
            <el-form-item label="入驻须知">
            </el-form-item>
            <el-form-item>
                <rich-text @rich-change="setSnotice" formfield="snotice"
                           :value="stayhomeform.snotice"></rich-text>
            </el-form-item>
            <el-form-item>
            ...
            initStayhome(sid){
                stayhomeRead(sid).then(res=>{
                    ...
                    if (res.data){
                       ...
                       this.bannerFileList=
                           res.data.sbanner1.map(ele=>({name:res.data.sname,url:this.IMGURL+ele}))
                    }
                }).catch(error=>{
                    console.log(error);
                });
